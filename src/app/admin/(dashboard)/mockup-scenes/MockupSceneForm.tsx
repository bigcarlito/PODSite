...
export function MockupSceneForm() {
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <label className="block">
        <span className="mb-1 block text-sm font-medium">Default price</span>
        <span className="mb-1 block text-xs text-muted">
          Used by the /admin/designs review queue&apos;s one-click &quot;make
          product&quot; button for this product type. Leave blank to keep
          the existing value.
        </span>
        <input
          name="defaultPrice"
